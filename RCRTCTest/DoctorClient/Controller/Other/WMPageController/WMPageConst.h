...
#define WMTitleColorNormal   [UIColor colorWithRed:1 green:0 blue:0 alpha:1]
//  导航菜单栏的背景颜色
#define WMMenuBGColor        [UIColor colorWithRed:0 green:244.0/255.0 blue:244.0/255.0 alpha:1.0]
